...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <!-- Menampilkan error ketika saldo tidak cukup -->
        ...
        <form action="/renter/pay/<?= $rental['id']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input type="date" min="<?= date('Y-m-d'); ?>" class="form-control" id="rental-end" name="rental-end" value="<?= $rental['rental_end']; ?>" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="total-rental-price" class="col-sm-2 col-form-label">Total harga sewa</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="total-rental-price" name="total-rental-price" value="<?= formatRupiah($rental['total_rental_price']); ?>" readonly>
                </div>
            </div>

            <div class="mb-4">
                <button type="submit" class="btn btn-info">Bayar</button>
                <a href="/renter/rental-data" class="btn btn-secondary">Batal</a>
            </div>
        </form>
